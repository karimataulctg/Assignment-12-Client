...
const ProductReviewQueue = () => {
  ...
  useEffect(() => {
    // Fetch all products
    axios.get('https://product-hunt-server-two.vercel.app/products')
      .then((response) => {
  ...
  const handleMakeFeatured = (productId) => {
    axios.put(`https://product-hunt-server-two.vercel.app/products/${productId}/feature`)
      .then(() => {
  ...
  const handleAccept = (productId) => {
    axios.put(`https://product-hunt-server-two.vercel.app/products/${productId}/status`, { status: 'Accepted' })
      .then(() => {
  ...
  const handleReject = (productId) => {
    axios.put(`https://product-hunt-server-two.vercel.app/products/${productId}/status`, { status: 'Rejected' })
      .then(() => {
